...
if ($_POST)
{
    ...
    $to_email         = "timecloudbusiness@gmailcom";
    $default_subject  = "Time Cloud - Nouveau Message";

    // Output Messages
    $success_mssg   = "Votre message a bien été envoyé, nous reviendrons vers-vous dès que possible.";
    $error_mssg     = "Une erreur est survenue lors de l'envoi de votre message";
    $short_mssg     = "Le champ message est vide, veuillez le compléter.";
    $empty_subject  = "Le champ sujet est vide, veuillez le compléter.";
    $empty_name     = "Le champ nom est vide, veuillez le compléter.";
    $empty_phone    = "Le champ téléphone est vide, veuillez le compléter.";
    $email_mssg     = "Veuillez indiquer une adresse email valide !";
